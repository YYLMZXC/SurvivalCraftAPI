...
namespace Game {
    public class WireBlock : Block, IElectricWireElementBlock, IPaintableBlock {
        ...
        public ElectricElement CreateElectricElement(SubsystemElectricity subsystemElectricity, int value, int x, int y, int z) => null;
        ...
        public override void GetDropValues(SubsystemTerrain subsystemTerrain,
            ...
            for (int i = 0; i < 6; i++) {
                if (WireExistsOnFace(oldValue, i)
                    ...
                    dropValues.Add(new BlockDropValue { Value = Terrain.MakeBlockValue(133, 0, SetColor(0, paintColor)), Count = 1 });
                }
            }
