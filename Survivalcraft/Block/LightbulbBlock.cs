...
namespace Game {
    public class LightbulbBlock : MountedElectricElementBlock, IPaintableBlock {
        ...
        public static string fName = "LightbulbBlock";
        ...
        public override void GetDropValues(SubsystemTerrain subsystemTerrain,
            ...
            dropValues.Add(new BlockDropValue { Value = Terrain.MakeBlockValue(139, 0, SetColor(0, color)), Count = 1 });
            showDebris = true;
        }
        ...
        public override ElectricElement CreateElectricElement(SubsystemElectricity subsystemElectricity, int value, int x, int y, int z) =>
            new LightBulbElectricElement(subsystemElectricity, new CellFace(x, y, z, GetFace(value)), value);
