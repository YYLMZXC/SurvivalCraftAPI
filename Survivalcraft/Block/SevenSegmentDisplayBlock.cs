...
namespace Game {
    public class SevenSegmentDisplayBlock : MountedElectricElementBlock {
        ...
        public override void GetDropValues(SubsystemTerrain subsystemTerrain,
            ...
            dropValues.Add(new BlockDropValue { Value = Terrain.MakeBlockValue(185, 0, SetColor(0, color)), Count = 1 });
            showDebris = true;
        }
        ...
        public override ElectricElement CreateElectricElement(SubsystemElectricity subsystemElectricity, int value, int x, int y, int z) =>
            new SevenSegmentDisplayElectricElement(subsystemElectricity, new CellFace(x, y, z, GetFace(value)));
