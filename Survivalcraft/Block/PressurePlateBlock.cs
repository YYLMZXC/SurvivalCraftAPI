...
namespace Game {
    public class PressurePlateBlock : MountedElectricElementBlock {
        ...
        public int[] m_creativeValuesByMaterial = [Terrain.MakeBlockValue(144, 0, 0), Terrain.MakeBlockValue(144, 0, 1)];
        ...
        public override void GetDropValues(SubsystemTerrain subsystemTerrain,
            ...
            dropValues.Add(new BlockDropValue { Value = Terrain.MakeBlockValue(144, 0, SetMaterial(0, material)), Count = 1 });
            showDebris = true;
        }
        ...
        public override ElectricElement CreateElectricElement(SubsystemElectricity subsystemElectricity, int value, int x, int y, int z) =>
            new PressurePlateElectricElement(subsystemElectricity, new CellFace(x, y, z, GetFace(value)));
