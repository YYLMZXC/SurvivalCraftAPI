...
namespace Game {
    public class OneLedBlock : MountedElectricElementBlock {
        ...
        public override void GetDropValues(SubsystemTerrain subsystemTerrain,
            ...
            out bool showDebris) {
            dropValues.Add(new BlockDropValue { Value = Terrain.MakeBlockValue(253, 0, 0), Count = 1 });
            showDebris = true;
        }
        ...
        public override ElectricElement CreateElectricElement(SubsystemElectricity subsystemElectricity, int value, int x, int y, int z) =>
            new OneLedElectricElement(subsystemElectricity, new CellFace(x, y, z, GetFace(value)));
