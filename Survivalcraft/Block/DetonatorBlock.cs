    ...
    public class DetonatorBlock : MountedElectricElementBlock {
        ...
        public override void DrawBlock(PrimitivesRenderer3D primitivesRenderer,
            ...
            if (texture == null) {
                ...
                BlocksManager.DrawMeshBlock(primitivesRenderer, m_standaloneBlockMesh, texture, color, 4f * size, ref matrix, environmentData);
            }
        }

        public override ElectricElement CreateElectricElement(SubsystemElectricity subsystemElectricity, int value, int x, int y, int z) =>
            new DetonatorElectricElement(subsystemElectricity, new CellFace(x, y, z, GetFace(value)));
